...
CHANNEL_LINK = "YOUR_CHANNEL_INVITE_LINK"
    ...
    if user_id in allowed_user_ids:
        ...
        try:
            ...
            if chat_member.status == 'member':
                ...
                response = f"You need to join our channel to use this command. Join here: {CHANNEL_LINK}"
...
Official Channel: t.me/SOULCRACKS
'''
...
def join_channel(message):
    bot.send_message(message.chat.id, f"Join our channel to use the /bgmi command: {CHANNEL_LINK}")
